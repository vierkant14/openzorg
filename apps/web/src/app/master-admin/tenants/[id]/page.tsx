      ...
      <header className="bg-navy-900 text-white">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-10 py-6">
          <div className="flex items-center gap-4">
            ...
            <a
              href={`/master-admin/tenants/${tenant.id}/settings`}
              className="inline-flex items-center gap-2 rounded-lg border border-navy-700 px-3 py-1.5 text-body-sm font-medium text-navy-200 hover:bg-navy-800 hover:text-white"
            >
